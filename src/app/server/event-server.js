...
const { sendToRenderer, isRendererReady, resizeForPetCount } = require('../windows/window-manager');
const PetRegistry = require('../pet/pet-registry');
const { healthCheck, readPid, killProcess, removePid } = require('../core/process-manager');
