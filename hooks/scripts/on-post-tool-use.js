...
async function main() {
  ...
  await sendEvent('action_completed', { permissionMode: input.permission_mode, toolName: input.tool_name, toolInput: input.tool_input, agentId: input.agent_id, toolUseId: input.tool_use_id });
